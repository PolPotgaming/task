...
private slots:
    void sendMessage() {
        ...
        int packetSize = 65507; // ћаксимальный размер UDP-пакета
        ...
        for (int i = 0; i < message.size(); i += packetSize) {
            ...
            QThread::msleep(10); // ѕауза дл€ гарантии последовательности пакетов
        }

        messageInput->clear();
        outgoingBox->append("Message delivered.");

        // сохранение сообщени€ в базе данных
        QSqlQuery query;
